...
嗨，大家好，这篇红黑树教程是2020年初新冠疫情刚开始的时候写的，突觉很多教程都没有讲清红黑树到底是怎么实现的，甚觉可惜，于是放入[数据结构](https://hunterhug.gitlab.io/goa.c)教程系列中。
...
数据结构中的 `2-3-4` 树对照实现的红黑树是普通的红黑树，而 `2-3` 树对照实现的红黑树是一种变种，称为左倾红黑树，其更容易实现（请看[2-3树和左倾红黑树](https://hunterhug.gitlab.io/goa.c/#/algorithm/search/llrb_tree)的介绍）。
